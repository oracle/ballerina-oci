...
# createOciUser
# + return - OciUser
public function createOciUser() returns OciUser {
    OciUser user = {
        id : "",
        compartmentId : "",
        name : "",
...
# createOciGroup
# + return - OciGroups
public function createOciGroup() returns OciGroups {
    OciGroups groupi = {
        id : "",
        compartmentId : "",
        name : "",
...
# createOciCompartment
# + return - OciCompartment
public function createOciCompartment() returns OciCompartment {
    OciCompartment compartment = {
        id : "",
        compartmentId : "",
        name : "",
        description : "",
